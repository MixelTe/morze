...
let lineCount = 0;
let lastHint = "";
let inputing: ((inp: string) => void) | null = null;
...
export function input(hint: string = "")
{
	lastHint = hint;
	print(hint, "");
	consoleEl.focus();
	return new Promise<string>(res => inputing = res);
}

export function print(text: string, end = "\n")
{
